...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name="Version", value=f"`6.3.2`")
        embed.add_field(name="Authors", value="`ishowspeed")
        ...
        if self.bot.version.is_prerelease:
            ...
            footer = f"You are on the prerelease version • the latest version is v9."
        ...
        embed.add_field(
            ...
            value="find out how then smh",
            inline=False,
        )

        embed.add_field(
            name="Support the Developers",
            value="Spacey.digital",
            inline=False,
        )
